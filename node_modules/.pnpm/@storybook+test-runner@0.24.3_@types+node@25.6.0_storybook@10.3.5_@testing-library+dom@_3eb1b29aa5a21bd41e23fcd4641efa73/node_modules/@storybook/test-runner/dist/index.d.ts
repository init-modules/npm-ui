...
declare const getTestRunnerConfig: (configDir?: string) => Promise<TestRunnerConfig | undefined>;
...
declare const transformPlaywright: (src: string, filename: string) => Promise<string>;

export { type HttpHeaderSetter, type PrepareContext, type PrepareSetter, type TestContext$1 as TestContext, type TestHook, type TestRunnerConfig, getJestConfig, getStoryContext, getTestRunnerConfig, setPostVisit, setPreVisit, setupPage, testPrefixer, transformPlaywright, waitForPageReady };
